...
public class PaintBrushToolUI extends JPanel implements ChangeListener {
	...
	private boolean change_slider = false;
	...
	public void setStoredPixel(Pixel p){
		store_pixel = p;
	}
	...
	public void setSliders(){
		red_slider.setValue((int) (store_pixel.getRed() * 100));
		green_slider.setValue((int) (store_pixel.getGreen() * 100));
		blue_slider.setValue((int) (store_pixel.getBlue() * 100));
	}
	...
	public boolean getChangeSlider(){
		return change_slider;
	}
